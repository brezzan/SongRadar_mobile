...
class favorites extends StatefulWidget {
  final int userid;
  final String username;
  const favorites({required this.userid, required this.username, Key? key}) : super(key: key);
...
class recommends extends StatefulWidget {
  final int userid;
  final String username;
  const recommends({required this.userid, required this.username, Key? key}) : super(key: key);
  @override
...
class songList extends StatefulWidget {
  final int userid;
  final String username;
  const songList({required this.userid, required this.username, Key? key}) : super(key: key);
...
class _songListState extends State<songList> {
  ...
  void initState() {
    ...
    _scrollControllerSong.addListener(_scrollListenerSong);
    fetchSongs().then((_) {//searchbar related
      setState(() {
        filteredSongs = songs_to_print;
      });
    });
...
class albumList extends StatefulWidget {
  final int userid;
  final String username;
  const albumList({required this.userid, required this.username, Key? key}) : super(key: key);
